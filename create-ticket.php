                        ...
                        <form class="form-horizontal" name="form1" method="post" action="" onSubmit="return valid();">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body bg-white">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <select name="tasktype" class="form-control select" required>
                                                ...
                                                <option>Fallo computadora</option>
                                                <option>Fallo de red</option>
                                                <option>Soporte Técnico</option>
                                                <option>Instalación de impresora</option>
                                                <option>Recuperación de Información</option>
                                                <option>Solicitud de instalación de software</option>
                                                <option>Otro</option>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Descripción<br> (Coloca la Ubicación donde es la falla) <BR>Coloca un número de Contacto</label>
                                        <div class="col-md-6 col-xs-12">
