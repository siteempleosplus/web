                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <p>Por favor haga clic abajo para mencionar los servicios de su interés.</p>
                                </div>
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="form-group">
                                                            <label class="check">
                                                                <input type="checkbox" class="icheckbox" name="services[]" value="Solicitud de Instalación de Software">Solicitud de Instalación de Software</label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-group">
                                                        <label class="check">
                                                            <input type="checkbox" class="icheckbox" name="services[]" value=" Otro"> Otro  (Especifique en el mensaje)</label>
                                                    </div>
