                ...
                <div class="grid-title no-border descriptive clickable">
                  ...
                  <p><span class="text-success bold">Ticket #<?php echo $row['ticket_id']; ?></span> - Fecha de Creación <?php echo $row['posting_date']; ?>
                    <?php
                      ...
                      if ($status === 'open') {
                          echo '<button class="btn btn-success btn-xs" disabled>Abierto</button>';
                      } elseif ($status === 'closed') {
                          echo '<button class="btn btn-danger-dark btn-xs" disabled>Cerrado</button>';
                      } else {
                          echo '<button class="btn btn-danger-dark btn-xs" disabled>' . htmlspecialchars($row['status']) . '</button>';
                      }
                    ?>
                  </p>
